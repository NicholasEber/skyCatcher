...
/*
** Spring 2016 Launch
** the TrapSat.h header may need to change for pin location.
*/
#include <Bridge.h>
#include <FileIO.h>
#include <Arduino.h>
...
void setup() {
  ...
  */
  delay(12000);
  Serial.print("Linux Processor Booted.\n");
  ...
  if(/*(alti > 30480) /*|| ?time?*/ lStat!=LOW) /*100000 feet*/
   {
    ...
    Serial.print("Closing Lids.\n");
    /*for (int pos = 0; pos <= 180; pos += 1) { // goes from 0 degrees to 180 degrees*/
      lidServo.write(0);              // tell servo to go to position in variable 'pos' 
      delay(1500);                    // waits 1.5sec for the servo to reach the position   
   }
